...
& $python3 pubsub.py --endpoint ajui4xigywped-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --cert pc_akkodis_windows.cert.pem --key pc_akkodis_windows.private.key --client_id basicPubSub --topic sdk/test/python --count 0